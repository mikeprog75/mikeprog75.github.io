...
<html>
    <head>
		...
		<title>Poser votre question</title>
    ...
    <body>
	  ...
	  <header>
            ...
            <section>
	            ...
	            <div id="recap">
				<p>Sur cette page, vous pouvez poser votre question. <br /><br />
				   Les règles à suivre sont les suivantes: <br /><br />
				   1- Vous devez être inscrit sur le site avant de poser votre question <br />
				   2- La discipline et le titre doivent être en rapport avec votre question <br />
...
<?php
  if (empty($_POST['pseudo']) && empty($_POST['titre_message']) && empty($_POST['message']))
  {
    ...
    echo '<form method="post" action="forum_pc.php"  name="formulaire">
	...
	$message=$_POST['message'];
			 ...
			 if (!preg_match("#^[A-Z]{1}+[a-z0-9.-\s]+$#", $titre_message) || empty($titre_message))
			 {
			   ...
			   $titre_message_erreur2 = "Ce titre existe déjà ";
			   $i++;
			 ...
			 if (empty($_POST['message']))
			 {
			   ...
			   if ($i==0)
               {
                                  ...
                                  else
					              {
					                 ...
					                 echo "Votre question a été postée";
									 
							// Insertion du message à l'aide d'une requête préparée
             $req = $bdd->prepare('INSERT INTO forum_pc ( pseudo, discipline, titre_message, message, date_message ) VALUES( :pseudo, :discipline, :titre_message, :message, NOW() )');
    ...
    else
    {
		...
		echo'<p>Cliquez <a href="./forum_pc.php">ici</a> pour recommencer</p>';
