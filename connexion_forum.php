...
{
	echo '<div id =formulaire><form method="post" action="connexion_forum.php" >
    <fieldset>
...
else
{
	...
	<p>Cliquez <a href="./connexion_forum.php">ici</a> pour revenir</p>';
    }
...
// Préparation de la requete
  ...
  $req->execute(array('pseudo' => htmlspecialchars($_POST['pseudo'])));
                   ...
                   . htmlspecialchars($donnee['pseudo'])  . '<br /><br />' . '<em> le </em>' . htmlspecialchars($donnee['date_message_fr']) . '</p>'; ?>
					...
					<div id = "z"><a href="espace_membre_forum.php?message=<?php echo $donnee['titre_message']; ?>">Réponses</a></div>
	...
	else // Acces pas OK !
	{
        ...
        entré est invalide.</p><p>Cliquez <a href="./connexion_forum.php">ici</a> 
