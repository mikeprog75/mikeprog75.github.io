...
<html>
	...
	<article>
		  ...
		  <div id = "retour_chat"><a href="chat_prive.php">Acceder à votre boite de messagerie privée</a></div><br /><br />
...
echo get_list_page($page, $nbr_pages, './galerie_perso.php?membre='.$membre);
