...
{
	echo '<div id =formulaire><form method="post" action="connexion_blog.php" >
    <fieldset>
...
else
{
	...
	<p>Cliquez <a href="./connexion_blog.php">ici</a> pour revenir</p>';
    }
...
// Préparation de la requete
  ...
  $req->execute(array('pseudo' => htmlspecialchars($_POST['pseudo'])));
                   ...
                   . htmlspecialchars($donnee['pseudo'])  . '<br /><br />' . '<em> le </em>' . htmlspecialchars($donnee['date_billet_fr']) . '</p>'; ?>
					...
					<div id = "input"><a href="espace_membre_blog.php?message=<?php echo $donnee['titre_billet']; ?>">Commentaires</a></div>
	...
	else // Acces pas OK !
	{
        ...
        entré est invalide.</p><p>Cliquez <a href="./connexion_blog.php">ici</a> 
