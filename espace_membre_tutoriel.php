...
<html>
	...
	<article>
		  ...
		  <div id = "nouv_rep"><p><a class = "nouv_rep" href="modif_tuto.php">Modifier vos tutoriels</a></p></div>
...
echo get_list_page($page, $nbr_pages, './espace_membre_tutoriel.php?tuto='.$topic);

echo ' ]</p>';
?>

Cliquez sur le lien <a href="vision_commentaire.php">Suivant</a> pour voir les commentaires publies
