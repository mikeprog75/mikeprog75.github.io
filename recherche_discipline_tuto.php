...
<html>
	...
	<body>
			...
			<article>
                    ...
                    $req = $bdd->prepare('SELECT id FROM tutoriels WHERE discipline = :discipline' );
                    ...
                    if (!$resultat)
                    {
                    echo 'Aucun tutoriel envoyé avec cette discipline';
                    }
                    else
                    {
					?>
  ...
  tutoriels WHERE discipline = :discipline  ORDER BY date_tutoriel DESC LIMIT 0,10');
  ...
  $req->execute(array('discipline' => htmlspecialchars($_POST['discipline'])));
        ...
        {
           echo "Veuillez selectionner la discipline"; 
        }
